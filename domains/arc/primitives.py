...
def _build_arc_primitives() -> list[Primitive]:
    ...
    unary_ops = [
        ...
        ("sort_columns_by_color_count", sort_cols_by_color_count),
        ...
        ("repeat_columns_2x",       repeat_cols_2x),
        ...
        ("and_halves_vertical",         and_halves_v),
        ...
        ("sort_columns_by_sum",         sort_cols_by_sum),
        ("fill_row_from_right",         fill_row_from_right),
        ("fill_column_from_bottom",     fill_col_from_bottom),
        ...
        ("complete_tile_from_modal_column",  complete_tile_from_modal_col),
        ...
        ("fill_background_from_border",     fill_bg_from_border),
        ...
        ("keep_unique_columns",     keep_unique_cols),
        ...
        ("extend_nonzero_fill_row",     extend_nonzero_fill_row),
        ("extend_nonzero_fill_column",  extend_nonzero_fill_col),
        ...
        ("fill_between_objects_horizontal", fill_between_objects_h),
        ("fill_between_objects_vertical",   fill_between_objects_v),
        ("fill_bounding_box_per_object",    fill_bbox_per_object),
        ("draw_rectangle_around_objects",   draw_rect_around_objects),
        # --- Batch 5: targeted near-miss improvements ---
        ("complete_symmetry_180",               complete_sym_180),
        ...
        ("propagate_in_subcells",               propagate_in_subcells),
        ...
        ("keep_minority_color_only",            keep_minority_color_only),
        ("keep_majority_color_only",            keep_majority_color_only),
        ("gravity_to_nearest_pixel",            gravity_to_nearest_pixel),
        ("shift_nonzero_to_gravity_center",     shift_nonzero_to_gravity_center),
        ("fill_zero_regions_with_neighbor_color", fill_zero_regions_with_neighbor_color),
        # --- Batch 6: targeted near-miss improvements ---
        ("move_objects_toward_each_other",  move_objects_toward_each_other),
...
def build_task_color_primitives(task_colors: set[int]) -> list[Primitive]:
    ...
    for c in colors:
        prims.append(Primitive(
            name=f"fill_background_{c}", arity=1,
    ...
    for c in colors:
        prims.append(Primitive(
            name=f"dominant_touching_accent_{c}", arity=1,
    ...
    for c in colors:
        prims.append(Primitive(
            name=f"fill_smallest_hole_{c}", arity=1,
    ...
    for accent in colors:
        for new in colors:
            if accent != new:
                prims.append(Primitive(
                    name=f"recolor_nonzero_in_{accent}_bbox_{new}", arity=1,
    ...
    for target in colors:
        for fill in colors:
            if target != fill:
                prims.append(Primitive(
                    name=f"fill_adjacent_to_{target}_with_{fill}", arity=1,
