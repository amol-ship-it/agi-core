...
class TestRunnerHelpers(unittest.TestCase):
    ...
    def test_resolve_from_preset(self):
        ...
        self.assertEqual(resolved["compute_cap"], 2_000_000)
    ...
    def test_compute_cap_presets(self):
        ...
        self.assertEqual(PRESETS["quick"]["compute_cap"], 2_000_000)
        self.assertEqual(PRESETS["default"]["compute_cap"], 2_000_000)
